...
<!-- Mirrored from demo.egenslab.com/html/hotelina/preview/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 21 Sep 2025 06:39:42 GMT -->

<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Hotelina - Luxury Hotel and Suits Booking HTML Template</title>
    <link rel="icon" href="../../guest/assets/images/bg/sm-logo.png" type="image/gif" sizes="20x20">

    <!-- css file link -->
    <link rel="stylesheet" href="../../guest/assets/css/all.css">

    <!-- bootstrap 5 -->
    <link rel="stylesheet" href="../../guest/assets/css/bootstrap.min.css">

    <!-- box-icon -->
    <link rel="stylesheet" href="../../guest/assets/css/boxicons.min.css">

    <!-- bootstrap icon -->
    <link rel="stylesheet" href="../../guest/assets/css/bootstrap-icons.css">

    <!-- jquery ui -->
    <link rel="stylesheet" href="../../guest/assets/css/jquery-ui.css">
    <link rel="stylesheet" href="../../guest/assets/css/jquery.fancybox.min.css">

    <!-- swiper-slide -->
    <link rel="stylesheet" href="../../guest/assets/css/swiper-bundle.min.css">

    <!-- slick-slide -->
    <link rel="stylesheet" href="../../guest/assets/css/slick-theme.css">
    <link rel="stylesheet" href="../../guest/assets/css/slick.css">

    <!-- select 2 -->
    <link rel="stylesheet" href="../../guest/assets/css/nice-select.css">

    <!-- animate css -->
    <link rel="stylesheet" href="../../guest/assets/css/magnific-popup.css">

    <!-- odometer css -->
    <link rel="stylesheet" href="../../guest/assets/css/odometer.css">
                ...
                <div class="top-bar-items">
                    <div class="email d-flex align-items-center">
                        ...
                        <div class="email-info">
                            <span>Email Now</span>
                            <h6><a
                                    href="https://demo.egenslab.com/cdn-cgi/l/email-protection#600518010d100c0520070d01090c4e030f0d"><span
                                    class="__cf_email__"
                                    data-cfemail="284d50494558444d684f45494144064b4745">[email&#160;protected]</span></a>
                            </h6>
                        </div>
                    </div>
...
<header class="header-area style-1">
    <div class="main-menu">
        <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
            <div class="mobile-logo-wrap ">
                <a href="index.html"><img alt="image" src="../../guest/assets/images/header-logo22.svg"></a>
    ...
    <div class="nav-right d-flex align-items-center">
        ...
        <div class="header-btn">
            <a class="btn--primary eg-btn" href="room-suits1-2.html">Book Now</a>
        </div>
            ...
            <div class="col-lg-12 px-0">
                <div class="hero-video">
                    <video autoplay loop="loop" muted preload="auto">
                        <source src="../../guest/assets/video/hotel-room-2021-11-03-20-39-09-utc.mp4" type="video/mp4">
                    </video>
                    ...
                    <div class="scroll-dowm">
                        <a href="#about-area"><img src="../../guest/assets/images/icons/scroll-down.svg" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="home-one-about pt-120 pb-120" id="about-area">
    <img class="about-vector" src="../../guest/assets/images/bg/h1-about-bg.png" alt="">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="about-content">
                    ...
                    <p>Welcome to the best five- luxury hotel in New York. Hotel is veryes elementum sesue the aucan
                        vestibulum aliquam justo in sapien on thi rutrum volutpat. Donec in quis the pellentesque
                        velit. Donec id velitel ac arcu posuere blane.</p>
                    <p>Hotel ut nisl quam nestibulum ac quam nec odio elementum oneni sceisuen the aucan ligula.
                        Orci varius natoque penatibus ethemen magnis discustent parturient monte nascete ridiculus
                        musclineorto nellentesque habitant forminy morbine.</p>
                    <div class="author-area d-flex align-items-center">
                        <div class="author-img">
                            <img class="img-fluid" src="../../guest/assets/images/bg/manager.png" alt="">
                        </div>
                        <div class="author-details">
                            <h5>Hotel Manager</h5>
                            <img src="../../guest/assets/images/bg/manager-name.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="about-img">
                    <img class="img-fluid" src="../../guest/assets/images/bg/home-about-img.png" alt="">
                    <div class="reviews">
                        <h2>5.0</h2>
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="single-room">
                    <img class="img-fluid" src="../../guest/assets/images/bg/room1.png" alt="">
                    ...
                    <div class="room-content">
                        ...
                        <div class="bed-and-person d-flex align-items-center">
                            <div class="bed-qty">
                                <p><img src="../../guest/assets/images/icons/double-bed.svg" alt=""> 2 Double Bed</p>
                            </div>
                            <div class="persons">
                                <p><img src="../../guest/assets/images/icons/persons.svg" alt="">8 Guest</p>
                            </div>
                        </div>
                        <div class="book-btn">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-room">
                    <img class="img-fluid" src="../../guest/assets/images/bg/room2.png" alt="">
                    <div class="background"></div>
                    <div class="room-content">
                        <div class="price-tag">
                        ...
                        <div class="bed-and-person d-flex align-items-center">
                            <div class="bed-qty">
                                <p><img src="../../guest/assets/images/icons/double-bed.svg" alt=""> 3 Double Bed</p>
                            </div>
                            <div class="persons">
                                <p><img src="../../guest/assets/images/icons/persons.svg" alt="">10 Guest</p>
                            </div>
                        </div>
                        <div class="book-btn">
                            <a class="btn--primary2" href="room-suits-details.html">Book Now</a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-room">
                    <img class="img-fluid" src="../../guest/assets/images/bg/room3.png" alt="">
                    <div class="background"></div>
                    <div class="room-content">
                        <div class="price-tag">
                        ...
                        <div class="bed-and-person d-flex align-items-center">
                            <div class="bed-qty">
                                <p><img src="../../guest/assets/images/icons/double-bed.svg" alt=""> 1 Double Bed</p>
                            </div>
                            <div class="persons">
                                <p><img src="../../guest/assets/images/icons/persons.svg" alt="">3 Guest</p>
                            </div>
                        </div>
                        <div class="book-btn">
                            <a class="btn--primary2" href="room-suits-details.html">Book Now</a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-room">
                    <img class="img-fluid" src="../../guest/assets/images/bg/room4.png" alt="">
                    <div class="background"></div>
                    <div class="room-content">
                        <div class="price-tag">
                        ...
                        <div class="bed-and-person d-flex align-items-center">
                            <div class="bed-qty">
                                <p><img src="../../guest/assets/images/icons/double-bed.svg" alt=""> 2 Single Bed</p>
                            </div>
                            <div class="persons">
                                <p><img src="../../guest/assets/images/icons/persons.svg" alt=""> 4 Guest</p>
                            </div>
                        </div>
                        <div class="book-btn">
                            <a class="btn--primary2" href="room-suits-details.html">Book Now</a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-room">
                    <img class="img-fluid" src="../../guest/assets/images/bg/room5.png" alt="">
                    <div class="background"></div>
                    <div class="room-content">
                        <div class="price-tag">
                        ...
                        <div class="bed-and-person d-flex align-items-center">
                            ...
                            <div class="persons">
                                <p><img src="../../guest/assets/images/icons/persons.svg" alt="">6 Guest</p>
                            </div>
                        </div>
                        <div class="book-btn">
                            <a class="btn--primary2" href="room-suits-details.html">Book Now</a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-room">
                    <img class="img-fluid" src="../../guest/assets/images/bg/room6.png" alt="">
                    <div class="background"></div>
                    <div class="room-content">
                        <div class="price-tag">
                        ...
                        <div class="bed-and-person d-flex align-items-center">
                            <div class="bed-qty">
                                <p><img src="../../guest/assets/images/icons/double-bed.svg" alt=""> 1 Single Bed</p>
                            </div>
                            <div class="persons">
                                <p><img src="../../guest/assets/images/icons/persons.svg" alt="">2 Guest</p>
                            </div>
                        </div>
                        <div class="book-btn">
                            <a class="btn--primary2" href="room-suits-details.html">Book Now</a>
                ...
                <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="swiper feature-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Restaurant001.png" alt=""></div>
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Restaurant002.png" alt=""></div>
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Restaurant003.png" alt=""></div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="pills-parking" role="tabpanel"
                        ...
                        <div class="swiper feature-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Car-Parking001.png" alt=""></div>
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Car-Parking002.png" alt=""></div>
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Car-Parking003.png" alt=""></div>
                            </div>
                            <div class="swiper-pagination"></div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pills-gym" role="tabpanel" aria-labelledby="pills-gym-tab">
                        <div class="swiper feature-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Gym001.png" alt=""></div>
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Gym002.png" alt=""></div>
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Gym003.png" alt=""></div>
                            </div>
                            <div class="swiper-pagination"></div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pills-spa" role="tabpanel" aria-labelledby="pills-spa-tab">
                        <div class="swiper feature-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Spa001.png" alt=""></div>
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Spa002.png" alt=""></div>
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Spa003.png" alt=""></div>
                            </div>
                            <div class="swiper-pagination"></div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pills-gaming" role="tabpanel"
                        ...
                        <div class="swiper feature-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Gaming001.png" alt=""></div>
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Gaming002.png" alt=""></div>
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Gaming003.png" alt=""></div>
                            </div>
                            <div class="swiper-pagination"></div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pills-transport" role="tabpanel"
                        ...
                        <div class="swiper feature-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Transport001.png" alt=""></div>
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Transport002.png" alt=""></div>
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Transport003.png" alt=""></div>
                            </div>
                            <div class="swiper-pagination"></div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pills-pool" role="tabpanel" aria-labelledby="pills-pool-tab">
                        <div class="swiper feature-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Pool001.png" alt=""></div>
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Pool002.png" alt=""></div>
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Pool003.png" alt=""></div>
                            </div>
                            <div class="swiper-pagination"></div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pills-locker" role="tabpanel" aria-labelledby="pills-locker-tab">
                        <div class="swiper feature-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Locker001.png" alt=""></div>
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Locker002.png" alt=""></div>
                                <div class="swiper-slide"><img class="img-fluid"
                                                               src="../../guest/assets/images/bg/Locker003.png" alt=""></div>
                            </div>
                            <div class="swiper-pagination"></div>
                        </div>
                    </div>
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-7">
                <div class="scroll-offer">
                    <div class="single-offer mb-30">
                        <img class="img-fluid" src="../../guest/assets/images/bg/offer-img-1.png" alt="">
                    ...
                    <div class="single-offer mb-30">
                        <img class="img-fluid" src="../../guest/assets/images/bg/offer-img-2.png" alt="">
                        <div class="offer-card d-flex align-items-center">
                            <div class="offer">
                                <svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div class="single-offer mb-30">
                        <img class="img-fluid" src="../../guest/assets/images/bg/offer-img-3.png" alt="">
                        <div class="offer-card d-flex align-items-center">
                            <div class="offer">
                                <svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                                    <path
            ...
            <div class="col-lg-5 col-md-9">
                <div class="single-offer2 mb-30">
                    <div class="offer-img">
                        <img class="img-fluid" src="../../guest/assets/images/bg/offer-img-21.png" alt="">
                    </div>
                    <div class="offer-batch">
                        <div class="offer">
                            <img src="../../guest/assets/images/icons/offer-bg.svg" alt="">
                            <div class="content">
                                <h4>50%</h4>
                                <span>OFF</span>
                            </div>
                ...
                <div class="single-offer2 mb-30">
                    <div class="offer-img">
                        <img class="img-fluid" src="../../guest/assets/images/bg/offer-img-22.png" alt="">
                    </div>
                    <div class="offer-batch">
                        <div class="offer">
                            <img src="../../guest/assets/images/icons/offer-bg.svg" alt="">
                ...
                <div class="single-offer2 mb-30">
                    <div class="offer-img">
                        <img class="img-fluid" src="../../guest/assets/images/bg/offer-img-23.png" alt="">
                    </div>
                    <div class="offer-batch">
                        <div class="offer">
                            <img src="../../guest/assets/images/icons/offer-bg.svg" alt="">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="testimonial-wrrap">
                            <img src="../../guest/assets/images/icons/left-quote.svg" alt="">
                            <div class="content">
                                <p>Curabitur magna nisi, egestas quis est in, finib
                                    Nunc sitaa amet do odiotadin gone interdum, maximusonei offen dolorbankon quis,
                                    ullamcor
                                    arcubl pellentesque foxthure themego odio. </p>
                            </div>
                            <div
                                    class="author-review-area d-flex justify-content-between align-items-center flex-erap">
                                <div class="authot-area d-flex align-items-center">
                                    <div class="author-img">
                                        <img src="../../guest/assets/images/bg/author-testimonial.png" alt="">
                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrrap">
                            ...
                            <div
                                ...
                                <div class="authot-area d-flex align-items-center">
                                    <div class="author-img">
                                        <img src="../../guest/assets/images/bg/author-testimonial111.png" alt="">
                                    </div>
                                    <div class="author-name-deg">
                                        <h4>Jordan Benom</h4>
                                        <p>Guest</p>
        ...
        <div class="row g-2">
            <div class="col-lg-4 col-md-6">
                <div class="gallery-item one">
                    <img class="img-fluid" src="../../guest/assets/images/bg/gallery-1.png" alt="gallery">
                    <a href="../../guest/assets/images/bg/gallery-1.png" data-fancybox="gallery"
            ...
            <div class="col-lg-4 col-md-6">
                <div class="gallery-item two">
                    <img class="img-fluid" src="../../guest/assets/images/bg/gallery-2.png" alt="gallery">
                    <a href="../../guest/assets/images/bg/gallery-2.png" data-fancybox="gallery"
                       class="gallary-item-overlay">
                        <i class="bi bi-eye"></i> </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="gallery-item three">
                    <img class="img-fluid" src="../../guest/assets/images/bg/gallery-3.png" alt="gallery">
                    <a href="../../guest/assets/images/bg/gallery-3.png" data-fancybox="gallery"
                       class="gallary-item-overlay">
                        <i class="bi bi-eye"></i> </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="gallery-item four">
                    <img class="img-fluid" src="../../guest/assets/images/bg/gallery-4.png" alt="gallery">
                    <a href="../../guest/assets/images/bg/gallery-4.png" data-fancybox="gallery"
                       class="gallary-item-overlay">
                        <i class="bi bi-eye"></i> </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="gallery-item five">
                    <img class="img-fluid" src="../../guest/assets/images/bg/gallery-5.png" alt="gallery">
                    <a href="../../guest/assets/images/bg/gallery-5.png" data-fancybox="gallery"
                       class="gallary-item-overlay">
                        <i class="bi bi-eye"></i> </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="gallery-item nine">
                    <img class="img-fluid" src="../../guest/assets/images/bg/gallery-7.png" alt="gallery">
                    <a href="../../guest/assets/images/bg/gallery-7.png" data-fancybox="gallery"
                       class="gallary-item-overlay">
                        <i class="bi bi-eye"></i> </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="gallery-item six">
                    <img class="img-fluid" src="../../guest/assets/images/bg/gallery-6.png" alt="gallery">
                    <a href="../../guest/assets/images/bg/gallery-6.png" data-fancybox="gallery"
                       class="gallary-item-overlay">
                        <i class="bi bi-eye"></i> </a>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-12 d-lg-block d-md-flex mr1 ">
                <div class="gallery-item seven">
                    <img class="img-fluid" src="../../guest/assets/images/bg/gallery-8.png" alt="gallery">
                    <a href="../../guest/assets/images/bg/gallery-8.png" data-fancybox="gallery"
                       class="gallary-item-overlay">
                        <i class="bi bi-eye"></i> </a>
                </div>
                <div class="gallery-item eight">
                    <img class="img-fluid" src="../../guest/assets/images/bg/gallery-9.png" alt="gallery">
                    <a href="../../guest/assets/images/bg/gallery-9.png" data-fancybox="gallery"
                       class="gallary-item-overlay">
                        <i class="bi bi-eye"></i> </a>
                </div>
            </div>
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="blog-wrrap">
                    <div class="blog-img">
                        <img src="../../guest/assets/images/blog/blog1.png" alt="">
                        <div class="batch">
                            <a href="blog.html">June 21, 2022</a>
                        </div>
                    </div>
                    <div class="blog-content">
                        <div class="blog-meta">
                            <a href="blog.html">By, Admin -</a> <a href="blog.html">Hotel</a>
                        </div>
                        <div class="blog-title">
                            <h4><a href="blog-details.html">veryes elementum sesuren then aucan vestibu.</a></h4>
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-wrrap">
                    <div class="blog-img">
                        <img src="../../guest/assets/images/blog/blog2.png" alt="">
                        <div class="batch">
                            <a href="blog.html">June 19, 2022</a>
                        </div>
                    </div>
                    <div class="blog-content">
                        <div class="blog-meta">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-wrrap">
                    <div class="blog-img">
                        <img src="../../guest/assets/images/blog/blog3.png" alt="">
                        <div class="batch">
                            <a href="blog.html">June 16, 2022</a>
                        </div>
                    </div>
                    <div class="blog-content">
                        <div class="blog-meta">
                        ...
                        <div class="blog-title">
                            <h4><a href="blog-details.html">Aenean quis nisl pretiuman nibh accumsan.</a></h4>
                        </div>
                        <div class="read-more-btn">
                            <a href="blog-details.html">
                                <svg width="43" height="10" viewBox="0 0 43 10" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="footer-items social-area">
                        ...
                        <div class="footer-logo text-center">
                            <img src="../../guest/assets/images/footer-logo1.svg" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 d-flex justify-content-sm-end justify-content-center">
                    <div class="footer-items contact ">
                        ...
                        <div class="hotline mb-30">
                            <div class="hotline-icon">
                                <img src="../../guest/assets/images/icons/f-phone.svg" alt="">
                            </div>
                            <div class="hotline-info">
                        ...
                        <div class="email mb-30">
                            <div class="email-icon">
                                <img src="../../guest/assets/images/icons/f-envlop.svg" alt="">
                            </div>
                            <div class="email-info">
                                <h6 class="mb-10"><a
                        ...
                        <div class="email">
                            <div class="email-icon">
                                <img src="../../guest/assets/images/icons/f-location.svg" alt="">
                            </div>
                            <div class="email-info">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-xl-6 d-flex justify-content-xl-end justify-content-center">
                        <div class="payment-mathort">
                            <ul>
                                <li>Pay with us:</li>
                                <li><a href="#"><img src="../../guest/assets/images/bg/visa.png" alt=""></a></li>
                                <li><a href="#"><img src="../../guest/assets/images/bg/mastercard.png" alt=""></a></li>
                                <li><a href="#"><img src="../../guest/assets/images/bg/amagonpay.png" alt=""></a></li>
                                <li><a href="#"><img src="../../guest/assets/images/bg/paypal.png" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
...
<script src="../../guest/assets/js/jquery-3.6.0.min.js"></script>
<script src="../../guest/assets/js/jquery-ui.js"></script>
<script src="../../guest/assets/js/bootstrap.bundle.min.js"></script>
<script src="../../guest/assets/js/swiper-bundle.min.js"></script>
<script src="../../guest/assets/js/slick.js"></script>
<script src="../../guest/assets/js/jquery.nice-select.js"></script>
<script src="../../guest/assets/js/odometer.min.js"></script>
<script src="../../guest/assets/js/jquery.fancybox.min.js"></script>
<script src="../../guest/assets/js/isotope.pkgd.min.js"></script>
<script src="../../guest/assets/js/viewport.jquery.js"></script>
