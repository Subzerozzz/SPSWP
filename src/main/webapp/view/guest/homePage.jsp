...
<html lang="en">
    ...
    <head>
        ...
        <link rel="icon" href="${pageContext.request.contextPath}/guest/assets/images/bg/sm-logo.png" type="image/gif" sizes="20x20">
            ...
            <div class="main-menu">
                <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                    <div class="mobile-logo-wrap ">
                        <a href="${pageContext.request.contextPath}/view/guest/homePage.jsp"><img alt="image" src="${pageContext.request.contextPath}/guest/assets/images/header-logo22.svg"></a>
                    ...
                    <div class="col-lg-12 px-0">
                        <div class="hero-video">
                            <video autoplay loop="loop" muted preload="auto">
                                <source src="${pageContext.request.contextPath}/guest/assets/video/hotel-room-2021-11-03-20-39-09-utc.mp4" type="video/mp4">
                            </video>
        ...
        <div class="home-one-about pt-120 pb-120" id="about-area">
            ...
            <div class="container">
                <div class="row align-items-center">
                        ...
                        <div class="about-content">
                            ...
                            <div class="author-area d-flex align-items-center">
                                <div class="author-img">
                                    <img class="img-fluid" src="${pageContext.request.contextPath}/guest/assets/images/bg/manager.png" alt="">
                                </div>
                                <div class="author-details">
                                    <h5>Hotel Manager</h5>
                                    <img src="${pageContext.request.contextPath}/guest/assets/images/bg/manager-name.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-img">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/guest/assets/images/bg/home-about-img.png" alt="">
                            <div class="reviews">
                                <h2>5.0</h2>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testimonial-wrrap">
                                    <img src="${pageContext.request.contextPath}/guest/assets/images/icons/left-quote.svg" alt="">
                                    <div class="content">
                                    ...
                                    <div
                                        ...
                                        <div class="authot-area d-flex align-items-center">
                                            <div class="author-img">
                                                <img src="${pageContext.request.contextPath}/guest/assets/images/bg/author-testimonial.png" alt="">
                                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-wrrap">
                                    ...
                                    <div
                                        ...
                                        <div class="authot-area d-flex align-items-center">
                                            <div class="author-img">
                                                <img src="${pageContext.request.contextPath}/guest/assets/images/bg/author-testimonial111.png" alt="">
                                            </div>
                                            <div class="author-name-deg">
                                                <h4>Jordan Benom</h4>
                                                <p>Guest</p>
                ...
                <div class="row g-2">
                    <div class="col-lg-4 col-md-6">
                        <div class="gallery-item one">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-1.png" alt="gallery">
                            <a href="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-1.png" data-fancybox="gallery"
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="gallery-item two">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-2.png" alt="gallery">
                            <a href="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-2.png" data-fancybox="gallery"
                               class="gallary-item-overlay">
                                <i class="bi bi-eye"></i> </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="gallery-item three">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-3.png" alt="gallery">
                            <a href="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-3.png" data-fancybox="gallery"
                               class="gallary-item-overlay">
                                <i class="bi bi-eye"></i> </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="gallery-item four">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-4.png" alt="gallery">
                            <a href="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-4.png" data-fancybox="gallery"
                               class="gallary-item-overlay">
                                <i class="bi bi-eye"></i> </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="gallery-item five">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-5.png" alt="gallery">
                            <a href="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-5.png" data-fancybox="gallery"
                               class="gallary-item-overlay">
                                <i class="bi bi-eye"></i> </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="gallery-item nine">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-7.png" alt="gallery">
                            <a href="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-7.png" data-fancybox="gallery"
                               class="gallary-item-overlay">
                                <i class="bi bi-eye"></i> </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="gallery-item six">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-6.png" alt="gallery">
                            <a href="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-6.png" data-fancybox="gallery"
                               class="gallary-item-overlay">
                                <i class="bi bi-eye"></i> </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-12 d-lg-block d-md-flex mr1 ">
                        <div class="gallery-item seven">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-8.png" alt="gallery">
                            <a href="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-8.png" data-fancybox="gallery"
                               class="gallary-item-overlay">
                                <i class="bi bi-eye"></i> </a>
                        </div>
                        <div class="gallery-item eight">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-9.png" alt="gallery">
                            <a href="${pageContext.request.contextPath}/guest/assets/images/bg/gallery-9.png" data-fancybox="gallery"
                               class="gallary-item-overlay">
                                <i class="bi bi-eye"></i> </a>
                        </div>
                    </div>
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-wrrap">
                            <div class="blog-img">
                                <img src="${pageContext.request.contextPath}/guest/assets/images/blog/blog1.png" alt="">
                                <div class="batch">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-wrrap">
                            <div class="blog-img">
                                <img src="${pageContext.request.contextPath}/guest/assets/images/blog/blog2.png" alt="">
                                <div class="batch">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-wrrap">
                            <div class="blog-img">
                                <img src="${pageContext.request.contextPath}/guest/assets/images/blog/blog3.png" alt="">
                                <div class="batch">
